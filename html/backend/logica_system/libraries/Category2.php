...
class Category2 {
    ...
    private function _buildElements($parent, $append) {
        ...
        if ($this->_hasChild($parent['id'])) {
            ...
            $list .= "</ul>";
            $list .= "</div>"
                    . "<div style='display:none' id='HijoEntidades" . $parent['id'] . "' padre='" . $parent['parent'] . "'>hola</div>";
        } else {
            $list .= '<li style="text-decoration: none;"><div  id="divElemento' . $parent['id'] . '" padre="' . $parent['parent'] . '" class="TextoDescriptivo Expuesto ClasificacionOpcion">'
                    . '<a class="" onclick="Ajax_BuscarEntidadesDependientes(' . $parent['id'] . ');">' . $parent['name'] . '</a>';
            ...
            $list.="<div style='display:none' id='HijoEntidades" . $parent['id'] . "' padre='" . $parent['parent'] . "'>hola22</div>";
        }
    }
