...
?>
    ...
    function Ajax_CargarAccion_Antecedentes(codigo) {
        var strParametros = "&codigo=" + codigo;
        Ajax_CargadoGeneralPagina('Bandeja/Antecedentes/Form', 'divVistaMenuPantalla', "divErrorBusqueda", '', strParametros);
    }
            ...
            <table id="divDetalle" class="tblListas Centrado " cellspacing="0" border="1" style="width: 95%;">
                <thead>
                    ...
                    <tr class="FilaCabecera">
                        ...
                        <th style="width:40%;"> <?php echo $this->lang->line('TablaOpciones'); ?> </th>
                        ...
                        {                    
                            ...
                            <tr class="<?php echo $strClase; ?>">
                                ...
                                <td style="text-align: center;">
                                    ...
                                    <span class="BotonSimple" onclick="Ajax_CargarAccion_Antecedentes('<?php echo $value["prospecto_id"]; ?>')">
                                            <?php echo $this->lang->line('TablaOpciones_revisar_antecedentes'); ?>
                                    </span>                                              
