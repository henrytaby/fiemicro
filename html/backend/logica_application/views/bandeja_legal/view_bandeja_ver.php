...
?>
    ...
    function Ajax_CargarAccion_Evaluacion(codigo) {
        var strParametros = "&codigo=" + codigo;
        Ajax_CargadoGeneralPagina('Legal/Evaluacion/Form', 'divVistaMenuPantalla', "divErrorBusqueda", 'SIN_FOCUS', strParametros);
    }

    function Ajax_CargarAccion_Legal(codigo) {
        var strParametros = "&codigo=" + codigo;
        Ajax_CargadoGeneralPagina('Bandeja/Legal/Form', 'divVistaMenuPantalla', "divErrorBusqueda", '', strParametros);
    }
...
<div id="divVistaMenuPantalla" align="center">   
    ...
    <div id="divCargarFormulario" class="TamanoContenidoGeneral">
        ...
        <div class="FormularioSubtituloImagenNormal" style="background: url(html_public/imagenes/logo_initium.png) no-repeat; background-size: contain; background-position: center;"> </div>
            ...
            <div class="FormularioSubtitulo"> Mi Bandeja - <?php echo $this->lang->line('LegalTitulo'); ?></div>
                        ...
                        {                    
                            ...
                            <tr class="<?php echo $strClase; ?>">
                                ...
                                <td style="text-align: center;">
                                    ...
                                    <?php
                                    // Sólo muestra la opción si tiene el Perfil
                                    if($this->mfunciones_generales->GetPermisoPorPerfil($_SESSION["session_informacion"]["codigo"] ,PERFIL_DEVOLVER_PROSPECTO) && $value["empresa_categoria_codigo"] != 1)
                                    {
                                    ?>

                                        <span class="BotonSimple" onclick="Ajax_CargarAccion_DevolverObservar('<?php echo $value["prospecto_id"]; ?>')">
                                    ...
                                    ?>
                                        ...
                                        <span class="BotonSimple" onclick="Ajax_CargarAccion_Evaluacion('<?php echo $value["prospecto_id"]; ?>')">
                                            <?php echo $this->lang->line('TablaOpciones_evaluacion_legal'); ?>
                                        </span>
                                    ...
                                    <span class="BotonSimple" onclick="Ajax_CargarAccion_Legal('<?php echo $value["prospecto_id"]; ?>')">
                                        <?php echo $this->lang->line('TablaOpciones_revisar_cumplimiento'); ?>
                                    </span>
