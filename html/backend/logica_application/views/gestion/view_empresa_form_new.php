...
<?php echo $strValidacionJqValidate; ?>
    ...
    Ajax_DarActualizarValidacionEnvioAjaxSegmentoForm("FormularioRegistroLista", 'Nuevo/Empresa/Guardar',
...
<div id="divVistaMenuPantalla" align="center">
    ...
    <div id="divCargarFormulario" class="TamanoContenidoGeneral">
        ...
        <div class="FormularioSubtituloImagenNormal" style="background: url(html_public/imagenes/logo_senaf.png) no-repeat; background-size: contain; background-position: center;"> </div>
            ...
            <div class="FormularioSubtitulo"> Registro Nueva Empresa </div>
            <div class="FormularioSubtituloComentarioNormal "> En este apartado podrá registrar una nueva empresa, puede completar la información de la misma actualizando su data desde la bandeja de Empresas. </div>
            ...
            <tr class="<?php echo $strClase; ?>">
                ...
                <td style="width: 70%;">
                    <?php                                            
                        ...
                        {
                            echo html_select('ejecutivo_id', $arrEjecutivo, 'ejecutivo_id', 'usuario_nombre', 'SINSELECCIONAR', '');
                        }
                    ?>
                </td>
            </tr>
    ...
    <div id="confirmacion" class="PreguntaConfirmacion TamanoContenidoGeneral">
        ...
        <div class="FormularioSubtituloImagenPregunta"> </div>
            ...
            <div class="PreguntaTexto "> ¿Verificó que toda la información sea la correcta? </div>
