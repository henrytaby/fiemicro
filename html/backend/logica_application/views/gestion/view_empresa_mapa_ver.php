...
<div style="overflow-y: auto; height: 550px;">
    ...
    <iframe id="mapa_visor" frameborder="0" scrolling="no" class="mapa_iframe" style="height: 550px !important;" src="<?php echo (site_url('Empresa/Zona/Mapa') . '?estructura_id=' . $estructura_id);?>">>    </iframe>
