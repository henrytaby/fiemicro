...
<div id="divVistaMenuPantalla" align="center">   
    ...
    <div id="divCargarFormulario" class="TamanoContenidoGeneral">
        ...
        <div class="FormularioSubtituloImagenNormal" style="background: url(html_public/imagenes/logo_senaf.png) no-repeat; background-size: contain; background-position: center;"> </div>
            ...
            <div class="FormularioSubtitulo"> Gestión de Información de Empresas Registradas </div>
            <div class="FormularioSubtituloComentarioNormal "> 
                En este apartado podrá actualizar la información de las empresas que se encuentren registradas en el sistema para dar mantenimiento. Esta actualización sólo tendrá efecto en la Base de Datos del Sistema.
                <br /><br />
