...
<?php echo $strValidacionJqValidate; ?>
    ...
    Ajax_DarActualizarValidacionEnvioAjaxSegmentoForm("FormularioRegistroLista", 'Registro/Empresa/Guardar',
...
<div id="divVistaMenuPantalla" align="center">
    ...
    <div id="divCargarFormulario" class="TamanoContenidoGeneral">
        ...
        <div class="FormularioSubtituloImagenNormal" style="background: url(html_public/imagenes/logo_senaf.png) no-repeat; background-size: contain; background-position: center;"> </div>
            ...
            <div class="FormularioSubtitulo"> Gestión de Información de la Empresa - <?php echo $arrRespuesta[0]["empresa_categoria_detalle"]; ?> </div>
        ...
        <table class="tablaresultados Mayuscula" style="width: 100%;" border="0">
            ...
            <tr class="<?php echo $strClase; ?>">
                ...
                <td style="width: 70%;">
                    <?php                                            
                        if(isset($arrEjecutivo[0]) && count($arrEjecutivo[0]) > 0)
                        {
                            $valor = $arrRespuesta[0]['ejecutivo_asignado_codigo'];
                            
                            echo html_select('ejecutivo_id', $arrEjecutivo, 'ejecutivo_id', 'usuario_nombre', '', $valor);
                        }
                        else
                        {
                            echo html_select('ejecutivo_id', $arrVacio, 'lista_codigo', 'lista_valor', 'SINSELECCIONAR', $valor);
                        }
                    ?>
                </td>
            </tr>
        ...
        <div class="Botones2Opciones">
            <a onclick="Ajax_CargarOpcionMenu('Registro/Empresa/Ver');" class="BotonMinimalista"> <?php echo $this->lang->line('BotonCancelar'); ?> </a>
        </div>
