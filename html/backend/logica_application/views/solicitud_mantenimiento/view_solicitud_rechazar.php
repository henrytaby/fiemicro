...
<?php echo $strValidacionJqValidate; ?>
    ...
    Ajax_DarActualizarValidacionEnvioAjaxSegmentoForm("FormularioRegistroLista", 'Mantenimiento/Rechazar/Guardar',
...
<div id="divVistaMenuPantalla" align="center">
    ...
    <div id="divCargarFormulario" class="TamanoContenidoGeneral">
        ...
        <div class="FormularioSubtituloImagenNormal" style="background: url(html_public/imagenes/logo_initium.png) no-repeat; background-size: contain; background-position: center;"> </div>
            ...
            <div class="FormularioSubtitulo"> <?php echo $this->lang->line('RechazarTitulo'); ?></div>
        ...
        <form id="FormularioRegistroLista" method="post">
            ...
            <input type="hidden" name="estructura_id" value="<?php if(isset($arrRespuesta[0]["solicitud_id"])){ echo $arrRespuesta[0]["solicitud_id"]; } ?>" />
    ...
    <div id="confirmacion" class="PreguntaConfirmacion TamanoContenidoGeneral">
        ...
        <div class="FormularioSubtituloImagenPregunta"> </div>
            ...
            <div class="PreguntaTexto "><?php echo $this->lang->line('rechazar_Pregunta2'); ?></div>
