...
?>    
    function Ajax_CargarAccion_Editar(codigo) {
        ...
        Ajax_CargadoGeneralPagina('Actividades/Registro', 'divVistaMenuPantalla', "divErrorBusqueda", '', strParametros);
    }
...
<div id="divVistaMenuPantalla" align="center">   
    ...
    <div id="divCargarFormulario" class="TamanoContenidoGeneral">
        ...
        <div class="FormularioSubtituloImagenNormal" style="background: url(html_public/imagenes/logo_initium.png) no-repeat; background-size: contain; background-position: center;"> </div>
            ...
            <div class="FormularioSubtitulo"> <?php echo $this->lang->line('ActividadesTitulo'); ?></div>
            <div class="FormularioSubtituloComentarioNormal "><?php echo $this->lang->line('ActividadesSubtitulo'); ?></div>
        
        <div style="clear: both"></div>
        
        <div align="left" class="BotonesVariasOpciones">

            <span class="BotonMinimalista" onclick="Ajax_CargarOpcionMenu('Actividades/Registro')">
