    ...
    <div style="width: 100%; overflow-x: auto">
        <table id="divDetalle" class="tblListas Centrado " cellspacing="0" border="1" style="width: 95%;">
            ...
            <tr>
                ...
                <th style="width: 7%;"><?php echo $this->lang->line('general_solicitante_corto'); ?></th>
                <th style="width: 7%;"><?php echo $this->lang->line('general_ci'); ?></th>
                <th style="width: 7%;"><?php echo $this->lang->line('import_campana'); ?></th>
                <th style="width: 7%;"><?php echo $this->lang->line('import_agente'); ?></th>
                <th style="width: 7%;"><?php echo $this->lang->line('prospecto_etapa_actual'); ?></th>
            ...
            ?>
                ...
                <?php foreach ($arrRespuesta as $key => $value):?>
                    <tr class="FilaBlanca">
                        ...
                        <td align="justify"><?php echo ($value["tipo"]==1 ? $this->mfunciones_generales->GetValorCatalogo($value["prospecto_id"], 'lead_actividades') : $this->lang->line('TablaNoRegistrosMinimo')); ?></td>
