...
<?php echo $strValidacionJqValidate; ?>
    ...
    Ajax_DarActualizarValidacionEnvioAjaxSegmentoForm("FormularioRegistroLista", 'Interno/Prospecto/Guardar',
...
<div id="divVistaMenuPantalla" align="center">
    ...
    <div id="divCargarFormulario" class="TamanoContenidoGeneral">
        ...
        <div class="FormularioSubtituloImagenNormal" style="background: url(html_public/imagenes/logo_initium.png) no-repeat; background-size: contain; background-position: center;"> </div>
            ...
            <div class="FormularioSubtitulo"> <?php echo $this->lang->line('NuevoSolicitudTitulo'); ?></div>
            ...
            <tr class="<?php echo $strClase; ?>">
                ...
                <td style="width: 70%;">
                    ...
                    <?php
                        ...
                        {
                            echo html_select('empresa_departamento', $arrDepartamento, 'lista_codigo', 'lista_valor', 'SINSELECCIONAR', '');
                        }
                    ?>
            ...
            <tr class="<?php echo $strClase; ?>">
                ...
                <td style="width: 70%;">
                    ...
                    <?php
                        ...
                        {
                            echo html_select('empresa_municipio', $arrCiudad, 'lista_codigo', 'lista_valor', 'SINSELECCIONAR', '');
                        }
                    ?>
            ...
            <tr class="<?php echo $strClase; ?>">
                ...
                <td style="width: 70%;">
                    ...
                    <?php                                            
                        ...
                        {
                            echo html_select('empresa_zona', $arrZona, 'lista_codigo', 'lista_valor', 'SINSELECCIONAR', '');
                        }
                    ?>
