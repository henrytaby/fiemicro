...
?>    
    function Ajax_CargarAccion_Editar(codigo) {
        ...
        Ajax_CargadoGeneralPagina('Persona/Registro', 'divVistaMenuPantalla', "divErrorBusqueda", '', strParametros);
    }
		...
		<table id="divDetalle" class="tblListas Centrado " cellspacing="0" border="1" style="width: 80%;">
			<thead>
				...
				<tr class="FilaCabecera">
					...
					<th style="width:45%;">
					   <?php echo $this->lang->line('estructura_parent'); ?> </th>
						...
						<tr class="<?php echo $strClase; ?>">
							...
							<td style="text-align: center;">
								<?php echo $value["estructura_nombre"]; ?>
                                                        ...
                                                        <td style="text-align: center;">
								<?php echo $value["estructura_parent_detalle"]; ?>
							</td>
