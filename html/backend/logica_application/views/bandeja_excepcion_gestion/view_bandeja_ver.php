...
?>
    ...
    function Ajax_CargarAccion_Gestion(codigo) {
        var strParametros = "&codigo=" + codigo;
        Ajax_CargadoGeneralPagina('Excepcion/Gestion/Form', 'divVistaMenuPantalla', "divErrorBusqueda", '', strParametros);
    }
...
<div id="divVistaMenuPantalla" align="center">   
    ...
    <div id="divCargarFormulario" class="TamanoContenidoGeneral">
        ...
        <div class="FormularioSubtituloImagenNormal" style="background: url(html_public/imagenes/logo_initium.png) no-repeat; background-size: contain; background-position: center;"> </div>
            ...
            <div class="FormularioSubtitulo"> Mi Bandeja - <?php echo $this->lang->line('GestionTitulo'); ?></div>
                        ...
                        {                    
                            ...
                            <tr class="<?php echo $strClase; ?>">
                                ...
                                <td style="text-align: center;">
                                    ...
                                    <span class="BotonSimple" onclick="Ajax_CargarAccion_Gestion('<?php echo $value["prospecto_id"]; ?>')">
