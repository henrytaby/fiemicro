...
?>
    ...
    <div>
        ...
        <div class="row">
            ...
            <div class="col" style="text-align: center;">
                <label class='label-campo texto-centrado' for=''><?php echo number_format(((int)$producto_costo_medida_cantidad!=0 && $producto_costo_medida_precio!=0 ? 1-(($total_costo/$producto_costo_medida_cantidad)/$producto_costo_medida_precio) : 0), 2, ',', '.'); ?>%</label>
            </div>
        </div>
