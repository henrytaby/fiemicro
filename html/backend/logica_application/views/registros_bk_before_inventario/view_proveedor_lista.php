...
?>
    ...
    <table class="tablaresultados Mayuscula" style="width: 100% !important;" border="0">
        ...
        <tr class="FilaGris">
            ...
            <td style="width: 14%; font-weight: bold; text-align: center;">
                Opc.
            </td>
        ...
        ?>
                <tr class="FilaBlanca">
                    ...
                    <td style="width: 14%; font-weight: bold; text-align: center;" onclick="Proveedor_Nuevo(<?php echo $value["prospecto_id"]; ?>, <?php echo $value["proveedor_id"]; ?>);">
                        <span class="EnlaceSimple label-campo">
                            <strong> <i class="fa fa-pencil-square-o" aria-hidden="true"></i> </strong>
                        </span>
                    </td>

                    <td style="width: 14%; font-weight: normal; text-align: center;">
                    ...
                    <td style="width: 16%; font-weight: normal; text-align: center;">
                        <?php echo $value["proveedor_aclaracion"]; ?>
                    </td>
                </tr>
