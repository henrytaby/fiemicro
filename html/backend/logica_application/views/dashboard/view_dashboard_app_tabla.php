...
<div style="width: 100%; overflow-x: auto">
    <table id="divDetalle" class="tblListas Centrado " cellspacing="0" border="1" style="width: 100%;">
        ...
        <tr>
            ...
            <th style="width: 13%;"><?php echo $this->lang->line('general_solicitante_corto'); ?></th>
            <th style="width: 9%;"><?php echo $this->lang->line('general_ci'); ?></th>
            <th style="width: 9%;"><?php echo $this->lang->line('import_campana'); ?></th>
            <th style="width: 12%;"><?php echo $this->lang->line('general_actividad'); ?></th>
            <th style="width: 18%;"><?php echo $this->lang->line('general_destino'); ?></th>
            <th style="width: 9%;"><?php echo $this->lang->line('sol_monto_bs'); ?></th>
            <th style="width: 9%;"><?php echo $this->lang->line('terceros_columna8'); ?></th>
            <th style="width: 9%;">Días Transcurridos</th>
