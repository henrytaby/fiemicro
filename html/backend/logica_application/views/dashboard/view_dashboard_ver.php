...
<script type="text/javascript">
    ...
    function ReporteParamertos() {
        ...
        var strParametros = "&sel_departamento=" + $("#sel_departamento").val()
            ...
            + "&campoFiltroFechaDCDesde=" + $("#campoFiltroFechaDCDesde").val()
            + "&campoFiltroFechaDCHasta=" + $("#campoFiltroFechaDCHasta").val();
            ...
            $("#campoFiltroFechaDCDesde_tabla").val($("#campoFiltroFechaDCDesde").val());
            $("#campoFiltroFechaDCHasta_tabla").val($("#campoFiltroFechaDCHasta").val());
...
<div id="divVistaMenuPantalla" align="center">
    ...
    <div id="divCargarFormulario" class="TamanoContenidoGeneral">
        ...
        <form id="FormularioOpcionesReporte" method="post">
            ...
            <input type="hidden" name="campoFiltroFechaDCDesde_tabla" id="campoFiltroFechaDCDesde_tabla" />
            <input type="hidden" name="campoFiltroFechaDCHasta_tabla" id="campoFiltroFechaDCHasta_tabla" />
            ...
            ?>
                ...
                <input type="hidden" name="campoFiltroFechaDCDesde" id="campoFiltroFechaDCDesde" />
                <input type="hidden" name="campoFiltroFechaDCHasta" id="campoFiltroFechaDCHasta" />
                
                <div class="mensaje_resultado" style="width: 80%; text-align: center;"> <i class="fa fa-exclamation-circle" aria-hidden="true"></i> 
                    Lo sentimos, tu explorador no soporta algunas funcionalidades de este módulo. 
                    <br /> 
                    ...
                    <br /><br />
                    Puede generar el reporte total (sin filtros) haciendo <span class="EnlaceSimple" style="color: #ffffff; text-decoration: underline;" onclick="ReporteFunnel();">clic aquí</span>.
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <table style="width: 100%;" border="0">
                                        ...
                                        <tr>
                                            ...
                                            <td valign="middle" style="width: 35%;">
                                                <strong> Desde el: &nbsp;&nbsp;<span title="Limpiar" class="EnlaceSimple" onclick="$('#campoFiltroFechaDCDesde').val(''); return false;"> <i class="fa fa-trash-o" aria-hidden="true"></i> </span>
                                                    <input type="text" id="campoFiltroFechaDCDesde"/>
                                                </strong>
                                            </td>
                                            <td valign="middle" style="width: 35%;">
                                                <strong> Hasta el: &nbsp;&nbsp;<span title="Limpiar" class="EnlaceSimple" onclick="$('#campoFiltroFechaDCHasta').val(''); return false;"> <i class="fa fa-trash-o" aria-hidden="true"></i> </span>
                                                    <input type="text" id="campoFiltroFechaDCHasta"/>
                                                </strong>
                                            </td>
                                        </tr>
