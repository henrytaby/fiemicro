<form id="AgregarFiltroForm" method="post" action="">
    <table class="tablaresultados Mayuscula" style="width: 100%;" border="0">
        ...
        <tr class="FiltroReporteFilaTexto ui-helper-hidden">
            <td colspan="2">
                <input type="text" id="campoFiltroTexto" autocomplete="off" />
            </td>
        </tr>
...
<script type="text/javascript">
    ...
    function CargarOpcionesFiltroLista(campo) {
        var c=0;
        $.getJSON("<?php echo site_url("Bandeja/SupNorm/ValoresFiltro")?>",{"campo":campo}, function (data) {
            $(data).each(function () {
                c++;
    ...
    function GuardarFiltro() {
        ...
        switch (campo.tipo) {
            ...
            case "texto":
                ...
                var descripcion = "<i>" + (campo.tipo=="id" ? "Sea igual a" : "Contenga") + " </i> <b>" + $('#campoFiltroTexto').val() + "</b>";
            ...
            case "lista":
                ...
                var descripcion = descripciones.join(" <b>ó</b> ");
            ...
            case "fecha_simple":
                ...
                var descripcion = ((desde.length>0?"<i>Desde el:</i> " + desde:"") + (hasta.length>0?" <i>Hasta el:</i> " + hasta:"")).trim();
