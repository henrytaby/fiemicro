...
?>    
    function Ajax_CargarAccion_Editar(codigo) {
        ...
        Ajax_CargadoGeneralPagina('Agencia/Registro', 'divVistaMenuPantalla', "divErrorBusqueda", '', strParametros);
    }
...
<div id="divVistaMenuPantalla" align="center">   
    ...
    <div id="divCargarFormulario" class="TamanoContenidoGeneral">
        ...
        <div class="FormularioSubtituloImagenNormal" style="background: url(html_public/imagenes/logo_initium.png) no-repeat; background-size: contain; background-position: center;"> </div>
            ...
            <div class="FormularioSubtitulo"> <?php echo $this->lang->line('AgenciaTitulo'); ?></div>
            <div class="FormularioSubtituloComentarioNormal "><?php echo $this->lang->line('AgenciaSubtitulo'); ?></div>
        
        <div style="clear: both"></div>
        
        <div align="left" class="BotonesVariasOpciones">

            <span class="BotonMinimalista" onclick="Ajax_CargarOpcionMenu('Usuario/Listar')">
        ...
        <div align="left" class="BotonesVariasOpciones">
            ...
            <span class="BotonMinimalista" onclick="Ajax_CargarOpcionMenu('Agencia/Registro')">
		...
		<table id="divDetalle" class="tblListas Centrado " cellspacing="0" border="1" style="width: 80%;">
			<thead>
				...
				<tr class="FilaCabecera">
					...
					<th style="width:35%;">
					   <?php echo $this->lang->line('estructura_parent'); ?> <?php echo $this->lang->line('estructura_regional'); ?> </th>
					...
					{                    
						...
						<tr class="<?php echo $strClase; ?>">
							...
							<td style="text-align: center;">
								...
								<span class="BotonSimple" onclick="Ajax_CargarAccion_Editar('<?php echo $value["estructura_id"]; ?>')">
