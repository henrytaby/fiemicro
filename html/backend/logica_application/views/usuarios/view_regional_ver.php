...
?>    
    function Ajax_CargarAccion_Editar(codigo) {
        ...
        Ajax_CargadoGeneralPagina('Regional/Registro', 'divVistaMenuPantalla', "divErrorBusqueda", '', strParametros);
    }
...
<div id="divVistaMenuPantalla" align="center">   
    ...
    <div id="divCargarFormulario" class="TamanoContenidoGeneral">
        ...
        <div align="left" class="BotonesVariasOpciones">
            ...
            <span class="BotonMinimalista" onclick="Ajax_CargarOpcionMenu('Regional/Registro')">
		...
		<table id="divDetalle" class="tblListas Centrado " cellspacing="0" border="1" style="width: 80%;">
			<thead>
				...
				<tr class="FilaCabecera">
					...
					<th style="width:35%;">
					   <?php echo $this->lang->line('estructura_parent'); ?> <?php echo $this->lang->line('estructura_entidad'); ?> </th>
				...
				{                
                                    ...
                                    {                    
                                        ...
                                        <tr class="<?php echo $strClase; ?>">
                                            ...
                                            <td style="text-align: center;">
                                                    <?php echo $value["estructura_nombre"] . ($value["estructura_regional_estado"] == 0 ? ' (Cerrada)' : ''); ?>
                                            </td>
                                            <td style="text-align: center;">
