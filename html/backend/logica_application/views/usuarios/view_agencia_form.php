...
<?php echo $strValidacionJqValidate; ?>
    ...
    Ajax_DarActualizarValidacionEnvioAjaxSegmentoForm("FormularioRegistroLista", 'Agencia/Guardar',
...
<div id="divVistaMenuPantalla" align="center">
    ...
    <div id="divCargarFormulario" class="TamanoContenidoGeneral">
                ...
                <td style="width: 70%;">                
                    <?php                                            
                        if(count($arrParent[0]) > 0)
                        {
                            ...
                            echo html_select('catalogo_parent', $arrParent, 'estructura_regional_id', 'estructura_regional_nombre', '', $valor_parent);
                        }
                        else
                        {
        ...
        <div class="Botones2Opciones">
            <a onclick="Ajax_CargarOpcionMenu('Agencia/Ver');" class="BotonMinimalista"> <?php echo $this->lang->line('BotonCancelar'); ?> </a>
        </div>
