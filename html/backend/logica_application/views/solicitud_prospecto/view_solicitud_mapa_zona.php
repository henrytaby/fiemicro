...
<body>
    ...
    <div align="center">    
        <div id="direccion_actual" style="text-align: center; color: #ffffff; font-size: 12px; padding: 10px; border: 3px solid #ffffff; background-color: #006699; border-radius: 20px; font-weight: bold; width: 80%; font-family: 'Open Sans', Arial, sans-serif;"> <i>Puede copiar la dirección...</i> </div>
    </div>
