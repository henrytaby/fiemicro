...
<div id="divVistaMenuPantalla" align="center">
    ...
    <div id="divCargarFormulario" class="TamanoContenidoGeneral">
        ...
        <div class="Botones2Opciones">
            <a onclick="Ajax_CargarOpcionMenu('Afiliador/Ver');" class="BotonMinimalista"> <i class="fa fa-list-ol" aria-hidden="true"></i> <?php echo 'Ver ' . $this->lang->line('solicitud_estado_pendiente'); ?> </a>
        </div>
