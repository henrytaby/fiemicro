...
?>
    ...
    function CambiarAgenciaTercero(codigo, estado) {
        var strParametros = "&codigo=" + codigo + "&estado=" + estado ;
        Ajax_CargadoGeneralPagina('Afiliador/Cambiar/Agencia', 'divVistaMenuPantalla', "divErrorBusqueda", 'SIN_FOCUS', strParametros);
    }
    
    function Ajax_CargarAccion_Entregado(codigo, estado) {
        var strParametros = "&codigo=" + codigo + "&estado=" + estado + "&tipo_accion=1";
        Ajax_CargadoGeneralPagina('Afiliador/Agencia/Completar', 'divVistaMenuPantalla', "divErrorBusqueda", 'SIN_FOCUS', strParametros);
    }
    
    <?php
    // Req. Nuevos estados
    // Opciones de Cierre de Agencia = 20
    if($this->mfunciones_generales->GetPermisoPorPerfil($_SESSION["session_informacion"]["codigo"], 20))
    {
        
        echo '
                function Ajax_CargarAccion_NotificarCierre(codigo) {
                    var strParametros = "&codigo=" + codigo;
                    Ajax_CargadoGeneralPagina("Afiliador/Agencia/NotificarCierre", "divVistaMenuPantalla", "divErrorBusqueda", "", strParametros);
                }
            ';
        
        echo '
                function Ajax_CargarAccion_CuentaCerrada(codigo) {
                    var strParametros = "&codigo=" + codigo;
                    Ajax_CargadoGeneralPagina("Afiliador/Agencia/CuentaCerrada", "divVistaMenuPantalla", "divErrorBusqueda", "", strParametros);
                }
            ';
    }
    ?>
...
<div id="divVistaMenuPantalla" align="center">
    ...
    <div id="divCargarFormulario" class="TamanoContenidoGeneral">
        ...
        <div class="FormularioSubtituloImagenNormal" style="background: url(html_public/imagenes/logo_senaf.png) no-repeat; background-size: contain; background-position: center;"> </div>
            ...
            <div class="FormularioSubtitulo"> <?php echo $this->lang->line('AgenciaTercerosTitulo') . ' - ' . $this->lang->line('bandeja_agencia_pendientes') . $nombre_region; ?></div>
            <div class="FormularioSubtituloComentarioNormal "><?php echo $this->lang->line('AgenciaTercerosSubtitulo') . '<br /><br />Tiempo asignado a la Etapa: ' . $tiempo_etapa . ' hora(s) laboral(es).'; ?></div>
        ...
        <div align="left" class="BotonesVariasOpciones">
            ...
            <span class="BotonMinimalista" onclick="Ajax_CargarOpcionMenu('Afiliador/Agencia/Ver');">
        ...
        <div align="left" class="BotonesVariasOpciones">
            ...
            <span class="BotonMinimalista" onclick="Ajax_CargarOpcionMenu('Afiliador/Agencia/Reporte');">
        ...
        <div style="text-align: right !important; margin-left: 8%;">
            ...
            <?php $direccion_bandeja = 'Afiliador/Agencia/Ver'; ?>
                        ...
                        if ($mostrar)
                        {
                                ...
                                foreach ($arrRespuesta as $key => $value)
                                {
                                    ...
                                    <tr class="<?php echo $strClase; ?>">
                                        ...
                                        <td style="text-align: center;">
                                            <?php 
                                                echo $value["terceros_fecha"];
                                                
                                                if($value["notificar_cierre"] == 1)
                                                {
                                                    echo '<i><br /><br />' . $this->lang->line('notificar_cierre_texto') . '<br />' . $value["notificar_cierre_fecha"] . '</i>';
                                                }
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <?php
                                                ...
                                                if($value["notificar_cierre"] == 1)
                                                {
                                                    echo "<i class='fa fa-exclamation-triangle' aria-hidden='true' title='" . $this->lang->line('notificar_cierre_texto') . "'></i>";
                                                }
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <span class="BotonSimple" onclick="CambiarAgenciaTercero('<?php echo $value["terceros_id"]; ?>', <?php echo $estado; ?>)">
                                                <?php echo $this->lang->line('TablaOpciones_TransferirAgencia'); ?>
                                            </span>
                                            
                                            <span class="BotonSimple" onclick="Ajax_CargarAccion_Entregado('<?php echo $value["terceros_id"]; ?>', <?php echo $estado; ?>)">
                                                Marcar <br /> Entregado
                                            </span>

                                            <?php
                                            // Sólo muestra la opción si tiene el Perfil Opciones de Cierre de Agencia
                                            if($this->mfunciones_generales->GetPermisoPorPerfil($_SESSION["session_informacion"]["codigo"], 20))
                                            {
                                                if($value["notificar_cierre"] == 0)
                                                {
                                            ?>
                                                    <span class="BotonSimple" onclick="Ajax_CargarAccion_NotificarCierre('<?php echo $value["terceros_id"]; ?>')">
                                                        <?php echo $this->lang->line('AgenciaNotificarCierre'); ?>
                                                    </span>
                                                <?php
                                                }
                                                ?>
                                            
                                                <span class="BotonSimple" onclick="Ajax_CargarAccion_CuentaCerrada('<?php echo $value["terceros_id"]; ?>')">
                                                    <?php echo $this->lang->line('AgenciaCuentaCerrada'); ?>
                                                </span>
                                            <?php
                                            }
                                            ?>
