...
<?php echo $strValidacionJqValidate; ?>
    ...
    Ajax_DarActualizarValidacionEnvioAjaxSegmentoForm("FormularioRegistroLista", 'Afiliador/Agencia/Guardar',
...
<div id="divVistaMenuPantalla" align="center">
    ...
    <div id="divCargarFormulario" class="TamanoContenidoGeneral">
        ...
        <div class="FormularioSubtituloImagenNormal" style="background: url(html_public/imagenes/logo_senaf.png) no-repeat; background-size: contain; background-position: center;"> </div>
            ...
            <div class="FormularioSubtitulo"> <?php echo $this->lang->line('EntregarTitulo') . ' Onboarding' . $nombre_region; ?></div>
            <div class="FormularioSubtituloComentarioNormal ">Con este paso indica que realizó todas acciones respectivas y entregó los elementos pertinentes al cliente. Así mismo puede registrar un texto personalizado (opcional)</div>
        ...
        <table class="tablaresultados Mayuscula" style="width: 80% !important;" border="0">
            ...
            <tr class="<?php echo $strClase; ?>">
                ...
                <td style="width: 30%; font-weight: bold;">
                    Actualizar <?php echo $this->lang->line('monto_inicial'); ?> (Opcional)
                </td>

                <td style="width: 70%;">                
                    <?php echo $arrCajasHTML["monto_inicial"]; ?>
                </td>
            ...
            <tr class="<?php echo $strClase; ?>">
                ...
                <td style="width: 30%; font-weight: bold;">
                    <i class='fa fa-angle-double-right' aria-hidden='true'></i> Texto Personalizado (Opcional)
                </td>
    ...
    <div id="confirmacion" class="PreguntaConfirmacion TamanoContenidoGeneral">
        ...
        <div class="FormularioSubtituloImagenPregunta"> </div>
            ...
            <div class="PreguntaTexto "><?php echo $this->lang->line('entregado_Pregunta'); ?></div>
