...
<div id="divVistaMenuPantalla" align="center">
    ...
    <div id="divCargarFormulario" class="TamanoContenidoGeneral">
        ...
        <div class="FormularioSubtituloImagenNormal" style="background: url(html_public/imagenes/logo_senaf.png) no-repeat; background-size: contain; background-position: center;"> </div>
            ...
            <div class="FormularioSubtitulo"> Se procederá a Subir un Nuevo Documento al Prospecto </div>
            <div class="FormularioSubtituloComentarioNormal "> Para subir un nuevo archivo PDF y asociarlo al documento seleccionado del Prospecto, por favor proceda a seleccionarlo. Verifique que el Documento y la empresa seleccionada sean correctos.  </div>
        
        <div style="clear: both"></div>
                
        <br />

        <form action="Afiliador/Documento/Guardar" method="post" accept-charset="utf-8" enctype="multipart/form-data" name="frm1" id="frm1">
        ...
        <table class="tablaresultados Mayuscula" style="width: 80% !important;" border="0">
            ...
            <tr class="FilaGris">
                ...
                <td style="width: 30%; font-weight: bold;">
                    <br /><?php echo $arrProspecto[0]['empresa_categoria']; ?><br /><br />
                </td>

                <td style="width: 70%; font-weight: bold;">                
                    <?php echo $arrProspecto[0]['empresa_nombre']; ?>
                </td>
    ...
    <div id="confirmacion" class="PreguntaConfirmacion TamanoContenidoGeneral">
        ...
        <div class="FormularioSubtituloImagenPregunta"> </div>
            ...
            <div class="PreguntaTexto "> Se procederá a Subir el archivo seleccionado y será asociado al Documento del Prospecto indicado. </div>
