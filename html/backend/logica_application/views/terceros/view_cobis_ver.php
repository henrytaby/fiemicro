...
<?php echo $strValidacionJqValidate; ?>
    ...
    Ajax_DarActualizarValidacionEnvioAjaxSegmentoForm("FormularioRegistroLista", 'Afiliador/Cobis/Guardar',
...
<div id="divVistaMenuPantalla" align="center">
    ...
    <div id="divCargarFormulario" class="TamanoContenidoGeneral">
        ...
        <div class="FormularioSubtituloImagenNormal" style="background: url(html_public/imagenes/logo_senaf.png) no-repeat; background-size: contain; background-position: center;"> </div>
            ...
            <div class="FormularioSubtitulo"> Marcar Registrado en COBIS </div>
            <div class="FormularioSubtituloComentarioNormal ">Este paso es posterior a que el registro en COBIS fue correctamente realizado, pudiendo registrar la data respectiva y actualizar el estado del registro. Al proceder se notificará a la siguiente instancia de acuerdo a las agencias que supervisa (Regionalización).<br /><br /><div class="mensaje_resultado" style="width: 100%; text-align: center;"> <i class="fa fa-exclamation-circle" aria-hidden="true"></i> Importante: Al continuar con esta opción y registrar el "<?php echo $this->lang->line('onboarding_numero_cuenta'); ?>", confirma que completará el registro de forma manual en las instancias respectivas y ya no a través del flujo de registro COBIS mediante servicios web.</div></div>
        ...
        <table class="tablaresultados Mayuscula" style="width: 80% !important;" border="0">
            ...
            <tr class="<?php echo $strClase; ?>">
                ...
                <td style="width: 70%;">                
                    <?php echo $arrCajasHTML["onboarding_numero_cuenta"]; ?>
                </td>
    ...
    <div id="confirmacion" class="PreguntaConfirmacion TamanoContenidoGeneral">
        ...
        <div class="FormularioSubtituloImagenPregunta"> </div>
            ...
            <div class="PreguntaTexto "> Marcar la solicitud como Registrado en COBIS, actualizando la información con la data proporcionada. </div>
