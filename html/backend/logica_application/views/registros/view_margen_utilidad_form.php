...
<div class="container" style="overflow-y: auto; overflow-x: hidden; height: 375px;">
    ...
    <form id="FormularioRegistroLista" method="post" style="margin-bottom: 80px;">
        ...
        <div class='col-sm-12'><div class='form-group'><label class='label-campo' for='producto_nombre'>Descripción del Producto:</label><?php echo $arrCajasHTML['producto_nombre']; ?></div></div>
        ...
        <div class='col-sm-6'>
                ...
                <div class="row">
                    <div class="col" style="text-align: center;">
                        ...
                        if($rubro != 1)
                        {
                            ...
                            echo html_select('producto_categoria_mercaderia', $combo_mercaderia, 'id', 'campoDescrip', '', (isset($arrRespuesta[0]['producto_id']) ? $arrRespuesta[0]['producto_categoria_mercaderia'] : '-1'));
                        }
                        else
                        {
                            echo $arrCajasHTML['producto_categoria_mercaderia']; 
                        }
            ...
            <div class="container tab_margen" style="margin-top: 5px;">
                ...
                {
                    echo '<input type="hidden" name="producto_opcion" id="producto_opcion" value="3" />';
                }
                ?>
                
                <div class="row opcion_costeo">
                    <div class="col" style="text-align: center; color: #666666;">
                        <label class='label-campo' for=''><i class="fa fa-info-circle" aria-hidden="true"></i> <i>Ha seleccionado la opción de <strong>Costeo</strong>. Por favor registre el siguiente campo y una vez guardado recuerde registrar el detalle en el listado, con el botón </i><i style="font-size: 1.2em !important;" class="fa fa-cubes" aria-hidden="true"></i></label>
                    </div>
                </div>
                ...
                <div class="row <?php echo ($rubro==1||$rubro==2 ? 'opcion_personalizado' : ''); ?>">

                    <div class="col" style="text-align: center;">
                        <label class='label-campo' for='producto_venta_costo'><?php echo ($rubro==1||$rubro==2 ? 'Costo Unitario:' : 'Precio de Compra'); ?></label>
                    </div>
                    <div class="col" style="text-align: center;">
        ...
        <div class='col-sm-12' id="confirmacion" style="text-align: center;">
            ...
            <span class="texto-borrar"> <?php echo ($detalle_producto==1 ? 'ATENCIÓN: Éste item tiene asociado ' . $detalle_producto_cantidad . ' costo(s) dependiente(s), al continuar se eliminarán también los registros dependientes asociados. Esta acción no se puede deshacer.<br />' : ''); ?> ¿Confirma la acción de Eliminar? </span><br /><br />
