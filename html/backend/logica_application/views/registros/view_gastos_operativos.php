...
?>
    ...
    $(document).ready(function(){ 
        ...
        $('#operativos_sal_aguinaldos_monto').attr('disabled','disabled');
    });
    ...
    function gastos_salarios()
    {
        ...
        var inventario_total = 
        parseFloat($("#operativos_sal_libre1_monto").val() || 0) + 
        parseFloat($("#operativos_sal_libre2_monto").val() || 0) + 
        parseFloat($("#operativos_sal_libre3_monto").val() || 0) + 
        parseFloat($("#operativos_sal_libre4_monto").val() || 0);

        $("#operativos_sal_aguinaldos_monto").val((inventario_total/12).toFixed(2));
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="container gastos_salarios">
                    ...
                    <div class="row">
                        <div class="col" style="text-align: justify;">
                            <label class='label-campo' for='operativos_sal_aguinaldos_monto'><?php echo $this->lang->line('operativos_sal_aguinaldos_monto'); ?> <span class="AyudaTooltip" data-balloon-length="medium" data-balloon="Es la sumatoria de los montos de los Salarios divido por 12." data-balloon-pos="right"> </span> </label>
                        </div>
                        <div class="col" style="text-align: justify;">
