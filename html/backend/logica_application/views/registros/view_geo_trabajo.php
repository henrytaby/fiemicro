...
<script type="text/javascript">
        function UpdateMapaDragend(newLat, newLng)
        {
                ...
                parent.actualizar_geo_trab(newLat + ',' + newLng);
        }
        ...
        function initialize_map() {
                ...
                var myLatlng = new google.maps.LatLng(<?php echo $coordenadas_geo_trab; ?>);
                var myOptions = {
                        zoom: 15,
                        center: myLatlng,
                ...
                placesAutocomplete.bindTo('bounds', map);
                        ...
                        UpdateMapaClick(<?php echo $coordenadas_geo_trab; ?>);
        }
