...
<form id="FormularioRegistroLista" method="post">
    ...
    <div class="contenido_formulario container <?php echo $clase_contenido_extra; ?>">
        ...
        <div class="panel panel-default informacion_general">
            <div class="panel-heading"><?php echo $text_unidad_familiar; ?>Cálculo de la </div>
                    ...
                    <div class="container" style="margin-top: 5px;">
                        <div class="row">
                            ...
                            <div class="col" style="text-align: center;">
                                <label class='label-campo texto-centrado' for=''><?php echo $this->lang->line('operacion_antiguedad'); ?></label>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col" style="text-align: right;">
                                <label class='label-campo' for=''>Año(s):</label>
                            </div>
                            <div class="col" style="text-align: left;">
                                <?php echo $arrCajasHTML['operacion_antiguedad_ano']; ?>
                            </div>
                            <div class="col" style="text-align: right;">
                                <label class='label-campo' for=''>Mes(es):</label>
                            </div>
                            <div class="col" style="text-align: left;">
                                <?php echo $arrCajasHTML['operacion_antiguedad_mes']; ?>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col" style="text-align: center;">
                                <label class='label-campo texto-centrado' for=''><?php echo $this->lang->line('operacion_tiempo'); ?></label>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col" style="text-align: left;">
                                <?php echo $arrCajasHTML['operacion_tiempo_ano']; ?>
                            </div>
                            <div class="col" style="text-align: right;">
                                <label class='label-campo' for=''>Mes(es):</label>
                            </div>
                            <div class="col" style="text-align: left;">
                                <?php echo $arrCajasHTML['operacion_tiempo_mes']; ?>
                            </div>
