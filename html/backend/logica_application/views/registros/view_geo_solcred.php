...
<script type="text/javascript">
        function UpdateMapaDragend(newLat, newLng)
        {
                ...
                parent.actualizar_<?php echo $geo_registro; ?>(newLat + ',' + newLng);
        }
        ...
        function initialize_map() {
                ...
                var myLatlng = new google.maps.LatLng(<?php echo $coordenada_geo; ?>);
                var myOptions = {
                        zoom: 15,
                        center: myLatlng,
                ...
                placesAutocomplete.bindTo('bounds', map);
                        ...
                        UpdateMapaClick(<?php echo $coordenada_geo; ?>);
        }
