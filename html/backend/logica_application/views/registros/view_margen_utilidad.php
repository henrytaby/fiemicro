...
?>
    ...
    function Margen_Lista(codigo, tab) {
        var strParametros = "&estructura_id=" + codigo + "&tab=" + tab + "&rubro=" + <?php echo $codigo_rubro; ?>;
    ...
    function Margen_Nuevo(estructura_id, producto_id, tab) {
        var strParametros = "&estructura_id=" + estructura_id + "&producto_id=" + producto_id + "&tab=" + tab + "&rubro=" + <?php echo $codigo_rubro; ?>;
    ...
    function MostrarContenedor(tab){
        ...
        switch (tab) {
            ...
            case "2":
                ...
                $("#titulo_contenedor").html("Establezca el Inventario");
                $("#boton_nuevo").show();
                $("#boton_nuevo_margen").hide();
    ...
    {
        var metodo = $('#inventario_registro option:selected').val();
        var monto = $("#inventario_registro_total").val();
        
        var strParametros = "&estructura_id=" + <?php echo $estructura_id; ?> + "&metodo=" + metodo + "&monto=" + monto;
        
        Ajax_CargadoGeneralPagina('../Inventario/Guardar', 'Margen_Utilidad', "divErrorListaResultado", 'SIN_CARGA', strParametros);
        
        $("#mensaje_guardado").fadeIn();
    }
    ...
    <div class="contenido_formulario container <?php echo $clase_contenido_extra; ?>">
        ...
        <div id="ResultadoMargenUtilidad">
            ...
            <ul class="nav nav-tabs">
                ...
                <li onclick="MostrarContenedor('2')"><a id="tab2" class="panel-heading" data-toggle="tab" href="#tab_inventario"> <i class="fa fa-dot-circle-o" aria-hidden="true"></i> Inventario </a></li>
            </ul>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div style="text-align: right; display: block;" id="boton_nuevo_margen">

                        <span class="EnlaceSimple label-campo" onclick="Margen_Nuevo('<?php echo $estructura_id; ?>', '-1', '1');">
                            <strong> <i class="fa fa-plus-square" aria-hidden="true"></i> AÑADIR REGISTRO A MARGEN </strong>
                        </span>
