...
?>
    ...
    $('#extra_inventario').attr('disabled','disabled');
    ...
    <div class="contenido_formulario container gastos_familiares <?php echo $clase_contenido_extra; ?>">
        ...
        <div class="panel panel-default balance_totales" id="gastos_familiares">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col" style="text-align: justify;">
                        <label class='label-campo' for='extra_inventario'><?php echo $this->lang->line('extra_inventario'); ?> <span class="AyudaTooltip" data-balloon-length="medium" data-balloon="Es la sumatoria o total registrado en el apartado de Inventario. Para el rubro Transporte, Inventario tiene valor '0'" data-balloon-pos="right"> </span> </label>
                    </div>
                    <div class="col" style="text-align: justify;">
