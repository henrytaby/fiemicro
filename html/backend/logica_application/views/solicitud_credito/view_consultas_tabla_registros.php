<script type="text/javascript">
    ...
    !!!!! NOTA IMPORTANTE PARA INCLUIR LOS REPORTES !!!!!
    
    1. INCLUIR ESTA FUNCION JS
    
    // ***** !!! ESTE ES EL QUE VA A REPORTES PORQUE PUEDE OBSERVAR !!!
    ...
    2. Se tiene que tener 3 botones u opciones para el reporte:
            
            - Detalle del registro
            - Ver documentos
            - Observar documentos
    
                => ESTA OPCIÓN DEBE TENER LOS PERMISOS PARA "OBSERVAR" Y "DEVOLVER PROCESO" (PERFIL) ADEMÁS QUE DE EL ESTADO DEL REGISTRO DEBE TENER MARCADO
                EL CAMPO DE "ASIGNADO" (NO PUEDE DEVOLVERSE UN REGISTRO AL AIRE, SINO A UN OFICIAL DE NEGOCIO (USAURIO))
                
                PARA ESTA OPCIÓN HAY QUE LLAMAR A LA FUNCIÓN DEEL PASO 1 PORQUE YA TIENE LA OPCIÓN DE REGISTRAR OBSERVACIÓN Y REMITIR
                (ESTE S UN EJEMPLO DE COMO LLAMAR AL BOTÓN)
                
                <span class="BotonSimple" onclick="Ajax_CargarAccion_DocumentoProspecto('<?php echo $value["sol_id"]; ?>', '6')">
                    !Este observa. Va a reporte!
                </span>
