            ...
            ?>
                ...
                <div id="1">
                    ...
                    <table class="tablaresultados Mayuscula" style="width: 100%;" border="0">
                        ...
                        <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'>Vista actual (Completa)</td><td style='width: 70%;'>Cambiar a <span class="EnlaceSimple" onclick="Ajax_CargarAccion_DetalleSolicitudCred('<?php echo $arrRespuesta[0]["sol_id"]; ?>', 0);"> <strong> Vista Resumen <i class="fa fa-external-link" aria-hidden="true"></i> </strong> </span></td></tr>
                    ...
                    <table class="tablaresultados Mayuscula" style="width: 100%;" border="0">
                        ...
                        <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_fec_nac'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_fec_nac']; ?></td></tr>
                        <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_est_civil'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_est_civil']; ?></td></tr>
                        <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_nit'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_nit']; ?></td></tr>
                        <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_cliente'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_cliente']; ?></td></tr>
                        
                        <?php $strClase = $strClase == "FilaBlanca" ? "FilaGris" : "FilaBlanca"; ?> <tr class="<?php echo $strClase; ?>"> <td colspan="2" style="width: 100%; font-weight: bold; font-size: 1.5em; text-align: center;"> ACTIVIDAD PRINCIPAL </td> </tr>
                        ...
                        ?>
                            ...
                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_indepen_antiguedad'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_indepen_ant_ano'] . ' año(s) y ' . $arrRespuesta[0]['sol_indepen_ant_mes'] . ' mes(es)'; ?></td></tr>
                            
                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_indepen_atencion'); ?></td><td style='width: 70%;'><?php echo 'De ' . $arrRespuesta[0]['sol_indepen_horario_desde'] . ' a ' . $arrRespuesta[0]['sol_indepen_horario_hasta'] . $arrRespuesta[0]['sol_indepen_horario_dias']; ?></td></tr>
                        ...
                        ?>
                            ...
                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_depen_actividad'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_depen_actividad']; ?></td></tr>
                            ...
                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_depen_antiguedad'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_depen_ant_ano'] . ' año(s) y ' . $arrRespuesta[0]['sol_depen_ant_mes'] . ' mes(es)'; ?></td></tr>
                            
                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_depen_atencion'); ?></td><td style='width: 70%;'><?php echo 'De ' . $arrRespuesta[0]['sol_depen_horario_desde'] . ' a ' . $arrRespuesta[0]['sol_depen_horario_hasta'] . $arrRespuesta[0]['sol_depen_horario_dias']; ?></td></tr>
                            ...
                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_depen_tipo_contrato'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_depen_tipo_contrato']; ?></td></tr>
                        <?php
                        }
                        ?>
                        
                        <?php
                        if($arrRespuesta[0]['sol_actividad_secundaria'] == 1)
                        {
                        ?>
                            <?php $strClase = $strClase == "FilaBlanca" ? "FilaGris" : "FilaBlanca"; ?> <tr class="<?php echo $strClase; ?>"> <td colspan="2" style="width: 100%; font-weight: bold; font-size: 1.5em; text-align: center;"> ACTIVIDAD SECUNDARIA </td> </tr>
                            
                            <?php $strClase = $strClase == "FilaBlanca" ? "FilaGris" : "FilaBlanca"; ?> <tr class="<?php echo $strClase; ?>"> <td colspan="2" style="width: 100%; font-weight: bold; font-size: 1.3em; text-align: center;"> <?php echo $this->mfunciones_microcreditos->GetValorCatalogo($arrRespuesta[0]['sol_dependencia_sec'], 'sol_dependencia'); ?> </td> </tr>
                        
                            <?php
                            if($arrRespuesta[0]['sol_dependencia_sec'] == 2)
                            {
                            ?>
                                <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_indepen_actividad_sec'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_indepen_actividad_sec']; ?></td></tr>

                                <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_indepen_antiguedad_sec'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_indepen_ant_ano_sec'] . ' año(s) y ' . $arrRespuesta[0]['sol_indepen_ant_mes_sec'] . ' mes(es)'; ?></td></tr>

                                <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_indepen_atencion_sec'); ?></td><td style='width: 70%;'><?php echo 'De ' . $arrRespuesta[0]['sol_indepen_horario_desde_sec'] . ' a ' . $arrRespuesta[0]['sol_indepen_horario_hasta_sec'] . $arrRespuesta[0]['sol_indepen_horario_dias_sec']; ?></td></tr>

                                <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_indepen_telefono_sec'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_indepen_telefono_sec']; ?></td></tr>
                            <?php
                            }
                            ?>

                            <?php
                            if($arrRespuesta[0]['sol_dependencia_sec'] == 1)
                            {
                            ?>
                                <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_depen_empresa_sec'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_depen_empresa_sec']; ?></td></tr>
                                <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_depen_actividad_sec'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_depen_actividad_sec']; ?></td></tr>
                                <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_depen_cargo_sec'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_depen_cargo_sec']; ?></td></tr>

                                <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_depen_antiguedad_sec'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_depen_ant_ano_sec'] . ' año(s) y ' . $arrRespuesta[0]['sol_depen_ant_mes_sec'] . ' mes(es)'; ?></td></tr>

                                <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_depen_atencion_sec'); ?></td><td style='width: 70%;'><?php echo 'De ' . $arrRespuesta[0]['sol_depen_horario_desde_sec'] . ' a ' . $arrRespuesta[0]['sol_depen_horario_hasta_sec'] . $arrRespuesta[0]['sol_depen_horario_dias_sec']; ?></td></tr>

                                <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_depen_telefono_sec'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_depen_telefono_sec']; ?></td></tr>
                                <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_depen_tipo_contrato_sec'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_depen_tipo_contrato_sec']; ?></td></tr>
                            <?php
                            }
                            ?>
                        ...
                        <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_plazo'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_plazo']; ?></td></tr>
                        ...
                        <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_trabajo_lugar'); ?></td><td style='width: 70%;'><?php echo ($arrRespuesta[0]['sol_trabajo_lugar_codigo']==99 ? 'Otro: ' . $arrRespuesta[0]['sol_trabajo_lugar_otro'] : $arrRespuesta[0]['sol_trabajo_lugar']); ?></td></tr>
                        <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_trabajo_realiza'); ?></td><td style='width: 70%;'><?php echo ($arrRespuesta[0]['sol_trabajo_realiza_codigo']==99 ? 'Otro: ' . $arrRespuesta[0]['sol_trabajo_realiza_otro'] : $arrRespuesta[0]['sol_trabajo_realiza']); ?></td></tr>
                        ...
                        ?>
                            ...
                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_dir_departamento_sec'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_dir_departamento_sec']; ?></td></tr>
                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_dir_provincia_sec'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_dir_provincia_sec']; ?></td></tr>
                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_dir_localidad_ciudad_sec'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_dir_localidad_ciudad_sec']; ?></td></tr>
                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_cod_barrio_sec'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_cod_barrio_sec']; ?></td></tr>
                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_direccion_trabajo_sec'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_direccion_trabajo_sec']; ?></td></tr>
                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_edificio_trabajo_sec'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_edificio_trabajo_sec']; ?></td></tr>
                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_numero_trabajo_sec'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_numero_trabajo_sec']; ?></td></tr>


                            <?php $strClase = $strClase == "FilaBlanca" ? "FilaGris" : "FilaBlanca"; ?> <tr class="<?php echo $strClase; ?>"> <td colspan="2" style="width: 100%; font-weight: bold; font-size: 1.3em; text-align: center;"> <?php echo ($arrRespuesta[0]['sol_dir_referencia_sec']==0 ? 'Sin ' : ''); ?> Referencia de la dirección </td> </tr>

                            <?php
                            if($arrRespuesta[0]['sol_dir_referencia_sec'] == 1)
                            {
                            ?>
                                <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_geolocalizacion_sec'); ?></td>

                                    <td style="width: 70%;">
                                        <?php
                                        if(!preg_match('/^(\-?\d+(\.\d+)?),\s*(\-?\d+(\.\d+)?)$/', $arrRespuesta[0]["sol_geolocalizacion_sec"]))
                                        {
                                            echo "Geolocalización No Registrada";
                                        }
                                        else
                                        {
                                        ?>
                                            <a href="https://maps.google.com/?q=<?php echo $arrRespuesta[0]["sol_geolocalizacion_sec"]; ?>" target="_blank"> <i class="fa fa-map-marker" aria-hidden="true"></i> <strong>Ver Mapa</strong> </a>
                                        <?php
                                        }
                                        ?>
                                    </td>
                            ...
                            <?php
                            if($arrRespuesta[0]['sol_dir_referencia_sec'] == 2)
                            {
                                if($arrRespuesta[0]['sol_croquis_sec'] == '')
                                {
                                    $strClase = $strClase == "FilaBlanca" ? "FilaGris" : "FilaBlanca"; ?> <tr class="<?php echo $strClase; ?>"> <td colspan="2" style="width: 100%; text-align: center;"> Croquis seleccionado pero no registrado </td> </tr>
                                <?php
                                }
                            ...
                            ?>
                                    ...
                                    <tr class='<?php echo $strClase; ?>'>
                                        <td style='width: 30%; font-weight: bold;'>
                                            <?php echo $this->lang->line('sol_croquis_sec'); ?>
                                        </td>
                                        <td style='width: 70%;'>
                                            <span class="EnlaceSimple" onclick="VerTablaOnboarding('sol_croquis_sec');"> <i class="fa fa-map-o" aria-hidden="true"></i> <strong>Ver/Ocultar Imagen Croquis</strong> </span>
                                            <div style="display: none; text-align: center;" id="sol_croquis_sec">
                                                <br />
                                                <img src="<?php echo $arrRespuesta[0]['sol_croquis_sec']; ?>" style="max-width: 96%; background-color: #ffffff; border: 7px solid #ffffff; box-shadow: 0 4px 6px 0 rgb(0 0 0 / 20%), 0 4px 10px 0 rgb(0 0 0 / 19%); margin-bottom: 5px;" />
                                            </div>
                                        </td>
                                    </tr>
                            <?php
                            ...
                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_trabajo_lugar_sec'); ?></td><td style='width: 70%;'><?php echo ($arrRespuesta[0]['sol_trabajo_lugar_codigo_sec']==99 ? 'Otro: ' . $arrRespuesta[0]['sol_trabajo_lugar_otro_sec'] : $arrRespuesta[0]['sol_trabajo_lugar_sec']); ?></td></tr>
                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_trabajo_realiza_sec'); ?></td><td style='width: 70%;'><?php echo ($arrRespuesta[0]['sol_trabajo_realiza_codigo_sec']==99 ? 'Otro: ' . $arrRespuesta[0]['sol_trabajo_realiza_otro_sec'] : $arrRespuesta[0]['sol_trabajo_realiza_sec']); ?></td></tr>
                            
                        <?php
                        }
                        ?>

                        <?php $strClase = $strClase == "FilaBlanca" ? "FilaGris" : "FilaBlanca"; ?> <tr class="<?php echo $strClase; ?>"> <td colspan="2" style="width: 100%; font-weight: bold; font-size: 1.3em; text-align: center;"> DIRECCION DEL DOMICILIO </td> </tr>
                        
                        <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_dir_departamento_dom'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_dir_departamento_dom']; ?></td></tr>
                        <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_dir_provincia_dom'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_dir_provincia_dom']; ?></td></tr>
                        <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_dir_localidad_ciudad_dom'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_dir_localidad_ciudad_dom']; ?></td></tr>
                        <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_cod_barrio_dom'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_cod_barrio_dom']; ?></td></tr>
                        <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_direccion_dom'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_direccion_dom']; ?></td></tr>
                        <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_edificio_dom'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_edificio_dom']; ?></td></tr>
                        <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_numero_dom'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_numero_dom']; ?></td></tr>

                        <?php $strClase = $strClase == "FilaBlanca" ? "FilaGris" : "FilaBlanca"; ?> <tr class="<?php echo $strClase; ?>"> <td colspan="2" style="width: 100%; font-weight: bold; font-size: 1.3em; text-align: center;"> <?php echo ($arrRespuesta[0]['sol_dir_referencia_dom']==0 ? 'Sin ' : ''); ?> Referencia de la dirección </td> </tr>
                        
                        <?php
                        if($arrRespuesta[0]['sol_dir_referencia_dom'] == 1)
                        {
                        ?>
                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_geolocalizacion_dom'); ?></td>
                            
                                <td style="width: 70%;">
                                    <?php
                                    if(!preg_match('/^(\-?\d+(\.\d+)?),\s*(\-?\d+(\.\d+)?)$/', $arrRespuesta[0]["sol_geolocalizacion_dom"]))
                                    {
                                        echo "Geolocalización No Registrada";
                                    }
                                    else
                                    {
                                    ?>
                                        <a href="https://maps.google.com/?q=<?php echo $arrRespuesta[0]["sol_geolocalizacion_dom"]; ?>" target="_blank"> <i class="fa fa-map-marker" aria-hidden="true"></i> <strong>Ver Mapa</strong> </a>
                                    <?php
                                    }
                                    ?>
                                </td>
                        ...
                        <?php
                            if($arrRespuesta[0]['sol_dir_referencia_dom'] == 2)
                            {
                            if($arrRespuesta[0]['sol_croquis_dom'] == '')
                            {
                                $strClase = $strClase == "FilaBlanca" ? "FilaGris" : "FilaBlanca"; ?> <tr class="<?php echo $strClase; ?>"> <td colspan="2" style="width: 100%; text-align: center;"> Croquis seleccionado pero no registrado </td> </tr>
                            <?php
                            }
                        ...
                        ?>
                                ...
                                <tr class='<?php echo $strClase; ?>'>
                                    <td style='width: 30%; font-weight: bold;'>
                                        <?php echo $this->lang->line('sol_croquis_dom'); ?>
                                    </td>
                                    <td style='width: 70%;'>
                                        <span class="EnlaceSimple" onclick="VerTablaOnboarding('sol_croquis_dom');"> <i class="fa fa-map-o" aria-hidden="true"></i> <strong>Ver/Ocultar Imagen Croquis</strong> </span>
                                        <div style="display: none; text-align: center;" id="sol_croquis_dom">
                                            <br />
                                            <img src="<?php echo $arrRespuesta[0]['sol_croquis_dom']; ?>" style="max-width: 96%; background-color: #ffffff; border: 7px solid #ffffff; box-shadow: 0 4px 6px 0 rgb(0 0 0 / 20%), 0 4px 10px 0 rgb(0 0 0 / 19%); margin-bottom: 5px;" />
                                        </div>
                                    </td>
                                </tr>
                        <?php
                        ...
                        <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_dom_tipo'); ?></td><td style='width: 70%;'><?php echo ($arrRespuesta[0]['sol_dom_tipo_codigo']==99 ? 'Otro: ' . $arrRespuesta[0]['sol_dom_tipo_otro'] : $arrRespuesta[0]['sol_dom_tipo']); ?></td></tr>
                        ...
                        ?>
                            ...
                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_con_fec_nac'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_con_fec_nac']; ?></td></tr>
                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_con_est_civil'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_con_est_civil']; ?></td></tr>
                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_con_nit'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_con_nit']; ?></td></tr>
                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_con_cliente'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_con_cliente']; ?></td></tr>
                            ...
                            ?>
                                ...
                                <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_con_indepen_antiguedad'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_con_indepen_ant_ano'] . ' año(s) y ' . $arrRespuesta[0]['sol_con_indepen_ant_mes'] . ' mes(es)'; ?></td></tr>

                                <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_con_indepen_atencion'); ?></td><td style='width: 70%;'><?php echo 'De ' . $arrRespuesta[0]['sol_con_indepen_horario_desde'] . ' a ' . $arrRespuesta[0]['sol_con_indepen_horario_hasta'] . $arrRespuesta[0]['sol_con_indepen_horario_dias']; ?></td></tr>
                            ...
                            ?>
                                ...
                                <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_con_depen_actividad'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_con_depen_actividad']; ?></td></tr>
                                ...
                                <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_depen_antiguedad'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_con_depen_ant_ano'] . ' año(s) y ' . $arrRespuesta[0]['sol_con_depen_ant_mes'] . ' mes(es)'; ?></td></tr>

                                <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_depen_atencion'); ?></td><td style='width: 70%;'><?php echo 'De ' . $arrRespuesta[0]['sol_con_depen_horario_desde'] . ' a ' . $arrRespuesta[0]['sol_con_depen_horario_hasta'] . $arrRespuesta[0]['sol_con_depen_horario_dias']; ?></td></tr>
                                ...
                                <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_con_depen_tipo_contrato'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_con_depen_tipo_contrato']; ?></td></tr>
                            <?php
                            }
                            ?>
                            ...
                            <?php $strClase = $strClase == "FilaBlanca" ? "FilaGris" : "FilaBlanca"; ?> <tr class="<?php echo $strClase; ?>"> <td colspan="2" style="width: 100%; font-weight: bold; font-size: 1.3em; text-align: center;"> <?php echo ($arrRespuesta[0]['sol_con_dir_referencia']==0 ? 'Sin ' : ''); ?> Referencia de la dirección </td> </tr>
                            ...
                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_con_trabajo_lugar'); ?></td><td style='width: 70%;'><?php echo ($arrRespuesta[0]['sol_con_trabajo_lugar_codigo']==99 ? 'Otro: ' . $arrRespuesta[0]['sol_con_trabajo_lugar_otro'] : $arrRespuesta[0]['sol_con_trabajo_lugar']); ?></td></tr>
                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_con_trabajo_realiza'); ?></td><td style='width: 70%;'><?php echo ($arrRespuesta[0]['sol_con_trabajo_realiza_codigo']==99 ? 'Otro: ' . $arrRespuesta[0]['sol_con_trabajo_realiza_otro'] : $arrRespuesta[0]['sol_con_trabajo_realiza']); ?></td></tr>

                            <?php $strClase = $strClase == "FilaBlanca" ? "FilaGris" : "FilaBlanca"; ?> <tr class="<?php echo $strClase; ?>"> <td colspan="2" style="width: 100%; font-weight: bold; font-size: 1.3em; text-align: center;"> CÓNYUGE - DIRECCION DEL DOMICILIO </td> </tr>

                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_con_dir_departamento_dom'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_con_dir_departamento_dom']; ?></td></tr>
                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_con_dir_provincia_dom'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_con_dir_provincia_dom']; ?></td></tr>
                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_con_dir_localidad_ciudad_dom'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_con_dir_localidad_ciudad_dom']; ?></td></tr>
                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_con_cod_barrio_dom'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_con_cod_barrio_dom']; ?></td></tr>
                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_con_direccion_dom'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_con_direccion_dom']; ?></td></tr>
                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_con_edificio_dom'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_con_edificio_dom']; ?></td></tr>
                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_con_numero_dom'); ?></td><td style='width: 70%;'><?php echo $arrRespuesta[0]['sol_con_numero_dom']; ?></td></tr>

                            <?php $strClase = $strClase == "FilaBlanca" ? "FilaGris" : "FilaBlanca"; ?> <tr class="<?php echo $strClase; ?>"> <td colspan="2" style="width: 100%; font-weight: bold; font-size: 1.3em; text-align: center;"> <?php echo ($arrRespuesta[0]['sol_con_dir_referencia_dom']==0 ? 'Sin ' : ''); ?> Referencia de la dirección </td> </tr>

                            <?php
                            if($arrRespuesta[0]['sol_con_dir_referencia_dom'] == 1)
                            {
                            ?>
                                <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_con_geolocalizacion_dom'); ?></td>

                                    <td style="width: 70%;">
                                        <?php
                                        if(!preg_match('/^(\-?\d+(\.\d+)?),\s*(\-?\d+(\.\d+)?)$/', $arrRespuesta[0]["sol_con_geolocalizacion_dom"]))
                                        {
                                            echo "Geolocalización No Registrada";
                                        }
                                        else
                                        {
                                        ?>
                                            <a href="https://maps.google.com/?q=<?php echo $arrRespuesta[0]["sol_con_geolocalizacion_dom"]; ?>" target="_blank"> <i class="fa fa-map-marker" aria-hidden="true"></i> <strong>Ver Mapa</strong> </a>
                                        <?php
                                        }
                                        ?>
                                    </td>
                            ...
                            <?php
                            if($arrRespuesta[0]['sol_con_dir_referencia_dom'] == 2)
                            {
                                if($arrRespuesta[0]['sol_con_croquis_dom'] == '')
                                {
                                    $strClase = $strClase == "FilaBlanca" ? "FilaGris" : "FilaBlanca"; ?> <tr class="<?php echo $strClase; ?>"> <td colspan="2" style="width: 100%; text-align: center;"> Croquis seleccionado pero no registrado </td> </tr>
                                <?php
                                }
                            ...
                            ?>
                                    ...
                                    <tr class='<?php echo $strClase; ?>'>
                                        <td style='width: 30%; font-weight: bold;'>
                                            <?php echo $this->lang->line('sol_con_croquis_dom'); ?>
                                        </td>
                                        <td style='width: 70%;'>
                                            <span class="EnlaceSimple" onclick="VerTablaOnboarding('sol_con_croquis_dom');"> <i class="fa fa-map-o" aria-hidden="true"></i> <strong>Ver/Ocultar Imagen Croquis</strong> </span>
                                            <div style="display: none; text-align: center;" id="sol_con_croquis_dom">
                                                <br />
                                                <img src="<?php echo $arrRespuesta[0]['sol_con_croquis_dom']; ?>" style="max-width: 96%; background-color: #ffffff; border: 7px solid #ffffff; box-shadow: 0 4px 6px 0 rgb(0 0 0 / 20%), 0 4px 10px 0 rgb(0 0 0 / 19%); margin-bottom: 5px;" />
                                            </div>
                                        </td>
                                    </tr>
                            <?php
                            ...
                            <?php $strClase = $strClase == 'FilaBlanca' ? 'FilaGris' : 'FilaBlanca'; ?> <tr class='<?php echo $strClase; ?>'><td style='width: 30%; font-weight: bold;'><?php echo $this->lang->line('sol_con_dom_tipo'); ?></td><td style='width: 70%;'><?php echo ($arrRespuesta[0]['sol_con_dom_tipo_codigo']==99 ? 'Otro: ' . $arrRespuesta[0]['sol_con_dom_tipo'] : $arrRespuesta[0]['sol_con_dom_tipo']); ?></td></tr>
