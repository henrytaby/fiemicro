...
<?php echo $strValidacionJqValidate; ?>
    ...
    Ajax_DarActualizarValidacionEnvioAjaxSegmentoForm("FormularioRegistroLista", 'Excepcion/Justifica/Guardar',
...
<div id="divVistaMenuPantalla" align="center">
    ...
    <div id="divCargarFormulario" class="TamanoContenidoGeneral">
        ...
        <div class="FormularioSubtituloImagenNormal" style="background: url(html_public/imagenes/logo_initium.png) no-repeat; background-size: contain; background-position: center;"> </div>
            ...
            <div class="FormularioSubtitulo"> <?php echo $this->lang->line('JustificaTitulo'); ?></div>
        ...
        <table class="tblListas Centrado" style="width: 80%;" border="0">
            ...
            <tr class="FilaBlanca">
                <td style="text-align: justify;">
                    <strong><?php echo $this->lang->line('justificar_opcion_vobo'); ?></strong>
                </td>

                <td style="text-align: justify;">
                    <?php echo $this->lang->line('justificar_opcion_vobo_des'); ?>
                </td>
