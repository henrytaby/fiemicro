...
<?php echo $strValidacionJqValidate; ?>
    ...
    Ajax_DarActualizarValidacionEnvioAjaxSegmentoForm("FormularioRegistroLista", 'Auditoria/Resultado',
...
<div id="divVistaMenuPantalla" align="center">
    ...
    <div id="divCargarFormulario" class="TamanoContenidoGeneral">
        ...
        <div class="FormularioSubtituloImagenNormal" style="background: url(html_public/imagenes/logo_initium.png) no-repeat; background-size: contain; background-position: center;"> </div>
            ...
            <div class="FormularioSubtitulo"> <?php echo $this->lang->line('AuditoriaTitulo'); ?></div>
            <div class="FormularioSubtituloComentarioNormal "><?php echo $this->lang->line('AuditoriaSubtitulo'); ?></div>
		...
		<form id="FormularioRegistroLista" method="post">
			...
			<table class="tablaresultados Mayuscula" style="width: 100%;" border="0">
				...
				<tr class="<?php echo $strClase; ?>">
					...
					<td style="width: 30%;">
						<strong> <?php echo $this->lang->line('auditoria_tabla'); ?> </strong>
					</td>
					...
					<td style="width: 70%;">
                                            ...
                                            if(count($arrListadoTabla[0]) > 0)
                                            {
                                                echo html_select('tabla', $arrListadoTabla, 'lista_codigo', 'lista_valor', '', '');
                                            }
                                            else
                                            {
				...
				<tr class="<?php echo $strClase; ?>">
					...
					<td style="width: 30%;">
						<strong> <?php echo $this->lang->line('Usuario_user'); ?> </strong>
					</td>
					...
					<td style="width: 70%;">
                                            ...
                                            if(count($arrListadoUsuario[0]) > 0)
                                            {
                                                echo html_select('usuario', $arrListadoUsuario, 'lista_codigo', 'lista_valor', '', '');
                                            }
                                            else
                                            {
                                                echo $this->lang->line('TablaNoRegistros');
