...
<?php echo $strValidacionJqValidate; ?>
    ...
    Ajax_DarActualizarValidacionEnvioAjaxSegmentoForm("FormularioRegistroLista", 'Ejecutivo/TransfMant/Guardar',
...
<div id="divVistaMenuPantalla" align="center">
    ...
    <div id="divCargarFormulario" class="TamanoContenidoGeneral">
        ...
        <?php
            ...
            $tituloF = $this->lang->line('EjecutivoTitulo_mantenimiento_editar');
            $subtituloF = $this->lang->line('EjecutivoSubtitulo_mantenimiento_editar');
            $pregunta = $this->lang->line('ejecutivo_Pregunta5');
        ...
        <table class="tablaresultados Mayuscula" style="width: 80% !important;" border="0">
            ...
            <tr class="<?php echo $strClase; ?>">
                ...
                <td style="width: 70%;">
                    <span class="EnlaceSimple" onclick="Ajax_CargarAccion_DetalleMantenimiento('<?php echo $arrMantenimiento[0]["mant_id"]; ?>')">
                        <?php echo PREFIJO_MANTENIMIENTO . $arrMantenimiento[0]["mant_id"]; ?>                                    
                    </span>
                </td>
            </tr>
            ...
            <tr class="<?php echo $strClase; ?>">
                ...
                <td style="width: 70%;">
                    <span class="EnlaceSimple" onclick="Ajax_CargarAccion_DetalleEmpresa('<?php echo $arrMantenimiento[0]["empresa_id"]; ?>')">
                    <?php echo $arrMantenimiento[0]["empresa_nombre"]; ?>
                    </span>
                </td>
            ...
            <tr class="<?php echo $strClase; ?>">
                ...
                <td style="width: 70%;">
                    <?php echo $arrMantenimiento[0]["empresa_categoria"]; ?>
                </td>
            </tr>
