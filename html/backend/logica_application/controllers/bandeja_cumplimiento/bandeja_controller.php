 ...
 */
/**
 * Controlador para la gestión de Prospectos - CUMPLIMIENTO
 * @brief BANDEJA DE LA INSTANCIA
...
class Bandeja_controller extends MY_Controller {
	...
	protected $codigo_menu_acceso = 22;
        
        // Código de la Etapa Propio de la Bandeja
        protected $codigo_etapa = ETAPA_CUMPLIMIENTO;
    ...
    public function Bandeja_Ver() {
        ...
        $_SESSION['direccion_bandeja_actual'] = 'Bandeja/Cumplimiento/Ver';
        ...
        $this->load->view('bandeja_cumplimiento/view_bandeja_ver', $data);
    }
    
    public function Cumplimiento_Form() {
        $this->lang->load('general', 'castellano');
        $this->load->model('mfunciones_generales');
        $this->load->model('mfunciones_logica');
        ...
        else
        {
            ...
            $this->load->view('bandeja_cumplimiento/view_cumplimiento_form', $data);
        }
    }
    
    public function Cumplimiento_Guardar() {
        ...
        else
        {
            ...
            if($arrResultado3[0]['prospecto_etapa'] != ETAPA_RECHAZO)
            {
                ...
                if($opcion_seleccion == 1)
                {
                    ...
                    $this->mfunciones_logica->RevisionCumplimientoProspecto(1, 2, $nombre_usuario, $fecha_actual, $codigo_prospecto);
                ...
                if($opcion_seleccion == 2)
                {
                    ...
                    /***  REGISTRAR SEGUIMIENTO ***/
                    $this->mfunciones_logica->InsertSeguimientoProspecto($codigo_prospecto, ETAPA_RECHAZO, 7, 'Cumplimiento rechazó la Afiliación', $nombre_usuario, $fecha_actual);
