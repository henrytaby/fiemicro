...
class Detalle_controller extends MY_Controller {
    ...
    public function Informe_Generar() {
        ...
        {
            // Versión Actual
            $html_resultado = $this->mfunciones_generales->GeneraInformeLead($codigo_prospecto);
        }
        elseif($tipo == 'version')
        {
            // Versión Histórica
    ...
    public function ObservaDoc_Remitir() {
        ...
        else
        {
            ...
            // PASO 5: REMITIR CORREO ELECTRÓNICO DE OBSERVACIÓN AL EJECUTIVO DE CUENTAS
                ...
                $texto = $this->lang->line('prospecto_obs_doc_guardado');
    ...
    public function ProspectoDetalle() {
        ...
        else
        {
            ...
            else 
            {
                ...
                $arrResultado = $this->mfunciones_logica->ListadoDetalleProspecto($codigo_prospecto);
                $this->mfunciones_generales->Verificar_ConvertirArray_Hacia_Matriz($arrResultado);
