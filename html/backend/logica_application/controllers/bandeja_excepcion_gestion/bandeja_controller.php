 ...
 */
/**
 * Controlador para la gestión de Prospectos - EXCEPCIÓN - GESTIONA EXCEPCIÓN
 * @brief BANDEJA DE LA INSTANCIA
...
class Bandeja_controller extends MY_Controller {
	...
	protected $codigo_menu_acceso = 27;
        
        // Código de la Etapa Propio de la Bandeja
        protected $codigo_etapa = 9;
    ...
    public function Bandeja_Ver() {
        ...
        $_SESSION['direccion_bandeja_actual'] = 'Excepcion/Gestion/Ver';
        ...
        $this->load->view('bandeja_excepcion_gestion/view_bandeja_ver', $data);
    }
    ...
    public function Gestion_Form() {
        ...
        else
        {
            ...
            $this->load->view('bandeja_excepcion_gestion/view_excepcion_form', $data);
        }
    }
    
    public function Gestion_Guardar() {
        ...
        else
        {
            ...
            if($arrResultado3[0]['prospecto_etapa'] != 15)
            {
                ...
                if($opcion_seleccion == 1)
                {
                    ...
                    $this->mfunciones_generales->SeguimientoHitoProspecto($codigo_prospecto, 10, $this->codigo_etapa, $nombre_usuario, $fecha_actual, 2);
                    /***  REGISTRAR SEGUIMIENTO ***/
                    $this->mfunciones_logica->InsertSeguimientoProspecto($codigo_prospecto, 10, 1, 'Excepción - Justifica e Informa', $nombre_usuario, $fecha_actual);
                }
