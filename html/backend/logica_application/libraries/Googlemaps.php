...
class Googlemaps {
	...
	var $clusterMaxZoom			= 18;						// The maximum zoom level that a marker can be part of a cluster
	...
	function create_map()
	{
		...
		if ($this->maps_loaded == 0)
		{
			...
			<script type="text/javascript" src="' . site_url('html_public/js/clusterer/markerclusterer.js') . '"></script>
			'; }
		}
		if ($this->jsfile=="") {
			$this->output_js .= '
