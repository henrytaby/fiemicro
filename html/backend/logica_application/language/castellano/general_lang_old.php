...
$lang["conf_credito_notificar_sms_uri_ayuda"] = "Registre la URI del Web Service. Puede Testear la conexión, previamente debe registrar la autenticación 'bearer' e indicar un número celular para la prueba. EL TEST DEL WS-SMS CONSUMIRÁ UN SMS REAL (TIENE COSTO).";
...
$lang["conf_credito_notificar_texto"] = "Texto personalizado para la notificación (Máx 130 car.)";
$lang["conf_credito_notificar_texto_ayuda"] = "Es el texto personalizado para la notificación por SMS (y también en el correo si fue configurado en la plantilla de notificación). Puede registrar hasta 260 caracteres, se recomienda registrar 130 que es el límite para un SMS (caso contrario consumirá más SMS); procure no utilizar caracteres especiales o aquellos que no se visualicen correctamente en el SMS. Tip: Puede utilizar la variable {destinatario_nombre} para indicar el primer nombre del solicitante.";
...
$lang["EjecutivoTitulo"] = "Gestión de Oficiales de Negocio ";
$lang["EjecutivoSubtitulo"] = "En este apartado podrá gestionar los Oficiales de Negocio del Sistema que son los usuarios que utilizarán la APP. Como requisito indispensable para asignar a un Oficial de Negocio, tiene que ser un usuario registrado y con el Rol correspondiente al \"Ejecutivo/Oficial de Negocio Móvil (APP)\" <br /><br /> Podrá realizar la transferencia de cuentas y el seguimiento de Visitas Realizadas.";

$lang["EjecutivoTitulo_nuevo"] = "Habilitar un Usuario como ";
$lang["EjecutivoSubtitulo_nuevo"] = "Asigne un Usuario con Rol de tipo \"Oficial de Negocio\" para que se le asigne Clientes y/o Mantenimientos.";

$lang["EjecutivoTitulo_editar"] = "Transferir Cuenta";
$lang["EjecutivoSubtitulo_editar"] = "En este apartado podrá realizar el cambio y traspaso de las cuentas (Clientes, Solicitudes de Crédito) del Oficial de Negocio, a fin de asignarlo a otro usuario.";


$lang["ejecutivo_nombre"] = "Nombre del Oficial de Negocio";
$lang["ejecutivo_ejecutivo"] = "Oficial";
$lang["ejecutivo_zona"] = "Zona Asignada";

$lang["ejecutivo_Pregunta1"] = "Habilitar como Oficial de Negocio (Clientes) al usuario seleccionado.";
$lang["ejecutivo_Pregunta2"] = "Transferir la cuenta (Clientes) al usuario seleccionado.";
...
$lang["TablaOpciones_prospectos_asignados_titulo"] = "Clientes Asignados al Oficial de Negocio";
$lang["TablaOpciones_prospectos_asignados_subtitulo"] = "En este apartado podrá visualizar los Clientes asignados y gestionar los mismos, considere que sólo se visualizan los Clientes que se encuetren en Bandeja y aún no hayan sido Consolidados. Si requiere gestionar Clientes ya Consolidados, debe solicitarlo a Supervisor/Administrador.";
...
$lang["ejecutivo_advertencia"] = "<i class='fa fa-exclamation-triangle' aria-hidden='true'></i> Al transferir la cuenta, los leads y registros serán reasignados al Oficial de Negocios seleccionado.";
...
$lang["EjecutivoTitulo_zona"] = "Asignar Zona al Oficial de Negocio";
$lang["EjecutivoSubitulo_zona"] = "Para Guardar la ubicación de la Zona del Oficial de Negocio, solamente ubique el marcador y se guardará automáticamente. Si no ve el marcador o requiere registrar la posición manulmente puede hacer 'doble-clic' sobre el mapa.";

$lang["ejecutivo_ejecutivo_zona"] = "Zona del Oficial de Negocio";

$lang["EjecutivoTitulo_Mapa"] = "Mapa de Zonas de los Oficiales de Negocio ";

$lang["TablaOpciones_mapa_ejecutivo"] = "Mapa de <br /> Zonas Oficiales";

$lang["TablaOpciones_ejecutivo_indice"] = "Índice de <br /> Cumplimiento";

$lang["SeguimientoTitulo"] = "Tracking de ";
$lang["SeguimientoSubtitulo"] = "En este apartado podrá realizar el seguimiento de las ubicaciones de las visitas realizadas por los Oficiales de Negocio respecto al \"Check de la Visita\" efectuado. Para realizar el seguimiento: <br /><br /> 1. Seleccione el Oficial de Negocio <br /> 2. Seleccione el Rango de Fechas <br /> 3. Seleccione el Tipo de Visita a mostrar <br /> 4. Seleccione el Formato del Reporte que requiera ver";
...
$lang["ejecutivo_seguimiento_prospecto"] = "Clientes";
...
$lang["HorarioTitulo"] = "Horario de Visitas del Oficial de Negocio";
...
$lang["documento_remitir_consulta"] = "¿Esta seguro de remitir las observaciones del(los) documento(s) al Oficial de Negocio?";


$lang["ObservarDocTitulo"] = "Se procederá a Observar el Item Seleccionado";
$lang["ObservarDocSubtitulo"] = "Para efectivizar la observación, indique la acción solicitada al Oficial de Negocio lo más claro posible. Recuerde que después de registrar el detalle debe Remitir las Observaciones.";

$lang["prospecto_justificar"] = "Detalle la Observación/Justificación";
$lang["ObsDoc_Pregunta"] = "Observar Documento. Al realizar esta acción se marcará el documento como observado y deberá ser devuelto al Oficial de Negocio a través de la opción ubicada en \"Revisar Documentación\" o \"Elementos Digitalizados\".";

$lang["prospecto_obs_doc_guardado"] = " Se remitió las observaciones del Cliente al Oficial de Negocio.";
...
$lang["RegionalizaSubtitulo"] = "En este apartado podrá asignar una o más regiones para Supervisar. Por defecto el usuario tiene asignada la Agencia de la que depende, si selecciona/quita la misma Agencia de la que ya tiene asignada por defecto simplemente no tendrá ningún efecto.";

$lang["regionaliza_ayuda"] = "Podrá interactuar únicamente con registros de las regiones (Estructura Jerárquica) asignadas para su Supervisión. Si requiere otras/más estructuras puede solicitarlo al administrador del sistema.";
...
$lang["RegionUsuarioTitulo"] = "Asignación de Regiones a Supervisar";
$lang["RegionUsuarioSubtitulo"] = "En este apartado podrá asignar las regiones(Agencias) a usuarios específicos a fin de que puedan ver los Clientes sólo de los que corresponden a su(s) Agencia(s). <br /><br /> Si requiere adicionar más Agencias, o cambiar la Agencia asignada por defecto puede hacerlo a través del módulo de Gestión de Usuarios y Estructura.";
...
$lang["Usuario_perfil_app"] = "Acceso a Initium Móvil";
...
// -- Fecha de Corte
$lang["dashboard_fecha_corte"] = '2022-05-01'; // <-- Formato Y-m-d
// -- Fecha de Corte
